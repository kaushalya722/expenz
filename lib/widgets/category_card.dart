...
class CategoryCard extends StatefulWidget {
  ...
  const CategoryCard({super.key, required this.title, required this.amount, required this.total, required this.progressColor, required this.isExpence});
           ...
           Row(
            ...
            children: [
             Container(
              ...
              child: Row(
                children: [
                  Text(widget.title, style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: kBlack ),),
                  SizedBox(width: 10,),
                  Text("${(widget.amount/widget.total * 100).toStringAsFixed(2)} %",
                  style: TextStyle(
                    fontSize: 14,
